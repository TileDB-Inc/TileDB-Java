...
public class PointerUtils {
  ...
  public static charArray charArrayFromVoid(SWIGTYPE_p_void p) {
    return new charArray(SWIGTYPE_p_void.getCPtr(p), false);
  }

  public static floatArray floatArrayFromVoid(SWIGTYPE_p_void p) {
    return new floatArray(SWIGTYPE_p_void.getCPtr(p), false);
  }

  public static doubleArray doubleArrayFromVoid(SWIGTYPE_p_void p) {
    return new doubleArray(SWIGTYPE_p_void.getCPtr(p), false);
  }

  public static int8_tArray int8_tArrayFromVoid(SWIGTYPE_p_void p) {
    return new int8_tArray(SWIGTYPE_p_void.getCPtr(p), false);
  }

  public static uint8_tArray uint8_tArrayFromVoid(SWIGTYPE_p_void p) {
    return new uint8_tArray(SWIGTYPE_p_void.getCPtr(p), false);
  }

  public static int16_tArray int16_tArrayFromVoid(SWIGTYPE_p_void p) {
    return new int16_tArray(SWIGTYPE_p_void.getCPtr(p), false);
  }

  public static uint16_tArray uint16_tArrayFromVoid(SWIGTYPE_p_void p) {
    return new uint16_tArray(SWIGTYPE_p_void.getCPtr(p), false);
  }

  public static uint32_tArray uint32_tArrayFromVoid(SWIGTYPE_p_void p) {
    return new uint32_tArray(SWIGTYPE_p_void.getCPtr(p), false);
  }
