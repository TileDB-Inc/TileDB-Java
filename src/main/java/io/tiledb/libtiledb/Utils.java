...
public class Utils {
  ...
  public static int tiledb_query_set_data_buffer_nio(
      SWIGTYPE_p_tiledb_ctx_t ctx,
      SWIGTYPE_p_tiledb_query_t query,
      String name,
      ByteBuffer buffer,
      SWIGTYPE_p_unsigned_long_long buffer_size) {
    return tiledbJNI.tiledb_query_set_data_buffer_nio(
        SWIGTYPE_p_tiledb_ctx_t.getCPtr(ctx),
        SWIGTYPE_p_tiledb_query_t.getCPtr(query),
        name,
        buffer,
  ...
  public static int tiledb_query_set_offsets_buffer_nio(
      SWIGTYPE_p_tiledb_ctx_t ctx,
      SWIGTYPE_p_tiledb_query_t query,
      String name,
      ByteBuffer buffer,
      SWIGTYPE_p_unsigned_long_long buffer_size) {
    return tiledbJNI.tiledb_query_set_offsets_buffer_nio(
        SWIGTYPE_p_tiledb_ctx_t.getCPtr(ctx),
        SWIGTYPE_p_tiledb_query_t.getCPtr(query),
        name,
        buffer,
  ...
  public static int tiledb_query_set_validity_buffer_nio(
      SWIGTYPE_p_tiledb_ctx_t ctx,
      SWIGTYPE_p_tiledb_query_t query,
      String name,
      ByteBuffer buffer,
      SWIGTYPE_p_unsigned_long_long buffer_size) {
    return tiledbJNI.tiledb_query_set_validity_buffer_nio(
        SWIGTYPE_p_tiledb_ctx_t.getCPtr(ctx),
        SWIGTYPE_p_tiledb_query_t.getCPtr(query),
        name,
        buffer,
